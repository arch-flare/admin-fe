  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "All Products", route: "/shop/products" },
          { label: "Add Product", route: "/shop/products/add" },
          { label: "Stock Management", route: "/shop/products/stock" }
        ]
      },
      {
        icon: (
    ...
    menuItems: [
      {
        icon: (
          ...
          >
            <path
              d="M10.8563 0.55835C10.5188 0.55835 10.2095 0.8396 10.2095 1.20522V6.83022C10.2095 7.16773 10.4907 7.4771 10.8563 7.4771H16.8751C17.0438 7.4771 17.2126 7.39272 17.3251 7.28022C17.4376 7.1396 17.4938 6.97085 17.4938 6.8021C17.2688 3.28647 14.3438 0.55835 10.8563 0.55835Z"
              fill=""
            />
          </svg>
        ),
