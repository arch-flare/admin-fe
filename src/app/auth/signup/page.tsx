...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | Archflaire - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page Archflaire Dashboard Template",
  // other metadata
};
